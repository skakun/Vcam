...
public:
	...
	static void triangul(t_VV & input,t_VVV & output,t_VV &nodes);
	static void triangul(t_VVV & input,t_VVV & output, t_VV& nodes);
	static void triangul(t_Wall & wall ,t_VVV & output, t_VV& nodes);
